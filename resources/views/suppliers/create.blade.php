                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-10">
                                <input type="email" name="email" autocomplete="off" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" required value="{{ old('email') }}">
                                @if ($errors->has('email'))
                    ...
                    <div class="form-group">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-2">
                                <input type="text" id="onlyear" required name="tahun_lahir" autocomplete="off" class="form-control{{ $errors->has('tahun_lahir') ? ' is-invalid' : '' }}" value="{{ old('tahun_lahir') }}">
