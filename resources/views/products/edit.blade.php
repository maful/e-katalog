                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nama" autocomplete="off" class="form-control{{ $errors->has('nama') ? ' is-invalid' : '' }}" required value="{{ old('nama', $product->nama) }}">
                                @if ($errors->has('nama'))
                            ...
                            <div class="col-sm-10">
                                <select class="form-control{{ $errors->has('supplier_id') ? ' is-invalid' : '' }}" id="select2" name="supplier_id" required>
                                    ...
                                    @foreach ($suppliers as $supplier)
                                        <option value="{{ $supplier->id }}" {!! (old('supplier_id', $product->supplier_id) == $supplier->id ? "selected=\"selected\"" : "") !!}>{{ $supplier->nama }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="harga_jual" autocomplete="off" class="form-control{{ $errors->has('harga_jual') ? ' is-invalid' : '' }}" required value="{{ old('harga_jual', $product->harga_jual) }}">
                            ...
                            <div class="col-sm-10">
                                <div class="custom-controls-stacked">
                                    <label class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input{{ $errors->has('status') ? ' is-invalid' : '' }}" name="status" value="1"{!! old('status', $product->status) == '1' ? ' checked=""' : '' !!}>
                                        <span class="custom-control-label">Aktif</span>
                                    </label>
                                    <label class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input{{ $errors->has('status') ? ' is-invalid' : '' }}" name="status" value="0"{!! old('status', $product->status) == '1' ? '' : ' checked=""' !!}>
                    ...
                    <div class="form-group">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-4">
                                @if ($product->gambar != "")
                                    <img style="width: 100px;" src="{{ Storage::disk('public')->url('products/' . $product->gambar) }}" class="mb-3" alt="">
                                @endif
